...
export const LORE: Lore[] = [
  {
    ...
    body: "They stopped burying their dead the year the wells went bitter. Now they lower them on ropes and leave before the ropes stop swinging.",
  },
  {
    title: "WHAT I WAS",
  ...
  {
    title: "CORPSE WISP",
    body: "A mourner who would not stop mourning, boiled down to the useful part. It gives away everything it takes. I have never once made it stop.",
  },
  {
    title: "TOMB WARDEN",
